...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Edit Room Assignment</li>
</ol>
<script>
...
<form method="post" accept-charset="utf-8" action="<?= base_url() ?>index.php/room/roomAssign">
    ...
    <div class="form-group row">
        ...
        <div class="col-10">
            <input class="form-control" type="text" value="<?= $roomkey['room_number']?>" placeholder="" name="room_number">
        </div>
    </div>
     <div class="form-group row">
    ...
    <div class="form-group row" data-capture=".input-group, .datepicker">
        ...
        <div class="input-group date col-10">
            ...
            <input type="text" class="form-control" value="<?= $roomkey['startdate']?>" placeholder="Select start date" name="startdate" onchange="checkstartdate()" id="startdate" required>
    ...
    <div class="form-group row" data-capture=".input-group, .datepicker">
        ...
        <div class="input-group date col-10">
            ...
            <input type="text" class="form-control" value="<?= $roomkey['enddate']?>" placeholder="Select end date" name="enddate" id="enddate" onchange="checkdate()" required>
            <div class="input-group-append">
                <i class="fas fa-calendar-week"></i>
            </div>
        </div>
 ...
 <script>
    ...
    <div class="form-group row">
        ...
        <div class="input-group mb-3 col-10">
            <input class="form-control" type="text" value="<?= $roomkey['access_key']?>" placeholder="" name="access_key" id="access_key">
            <div class="input-group-append">
